...
<section className="min-h-screen bg-white flex flex-col items-center justify-center px-4 sm:px-6 md:px-10">
  {/* First grid */}
<div className="w-full max-w-7xl mx-auto flex flex-col items-center">
  <h2 className="text-5xl flex items-center justify-center font-bold text-center zalando-sans my-20">
    Why Choose Unlisted Edge?
  </h2>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 place-items-center w-full">
    ...
    <Card className="w-full max-w-xs sm:max-w-sm md:max-w-md">
      ...
      {/* How it Workssssssss */}
      <section className="min-h-screen bg-white flex flex-col items-center px-4 sm:px-6 md:px-10">
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center">
        <h2 className="mt-30 font-bold zalando-sans text-5xl my-20">
          How It Works?
        </h2>
