...
export function ProfileAvatarUploader() {
  ...
  return (
    <label className="cursor-pointer block">
      <div className="relative rounded-full w-20 h-20 sm:w-28 sm:h-28 md:w-50 md:h-50 lg:w-70 lg:h-70 xl:w-50 xl:h-50 mx-auto mt-6 border-8 border-black overflow-hidden">
  {profilePic ? (
    <Image
      src={profilePic}
      alt="Profile Pic"
